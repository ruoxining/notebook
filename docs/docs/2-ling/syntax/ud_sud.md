...
# Tools
[AllenNLP Demo](https://demo.allennlp.org/dependency-parsing){target="_blank"}
[CoreNLP Tool](https://corenlp.run/){target="_blank"}
...
## UD
*Dependency grammar* (DG) is an approach to the study of the syntax and grammar of natural languages that is quite distinct from *phrase structure grammar* (PSG), which is also known as *constituency grammar*. The modern history of DG begins with [Lucien Tesnière](https://en.wikipedia.org/wiki/Lucien_Tesni%C3%A8re){target="_blank"}'s major oeuvre (1959), whereas the modern history of PSG begins arguably with [Noam Chomsky](https://en.wikipedia.org/wiki/Noam_Chomsky){target="_blank"}'s first prominent work (1957).

DG views linguistic structures in terms of a *one-to-one mapping* of atomic linguistic units to the nodes in structure, whereas PSG assumes a *one-to-one-or-more mapping*. The distinction is clearly visible when one compares the tree structures. The next trees are taken from the [Wikipedia article on DG](https://en.wikipedia.org/wiki/Dependency_grammar){target="_blank"}:

![](../asset/Dependency&Constituency.png)

## SUD
[Surface Syntactic Universal Dependencies (SUD) | SUD](https://surfacesyntacticud.github.io/){target="_blank"}
...
- [subj](https://surfacesyntacticud.github.io/guidelines/u/relations/subj){target="_blank"}
- [udep](https://surfacesyntacticud.github.io/guidelines/u/relations/udep){target="_blank"}
- [comp](https://surfacesyntacticud.github.io/guidelines/u/relations/comp){target="_blank"}
    - [comp:aux](https://surfacesyntacticud.github.io/guidelines/u/relations/comp_aux){target="_blank"}
    - [comp:cleft](https://surfacesyntacticud.github.io/guidelines/u/relations/comp_cleft){target="_blank"}
    - [comp:obj](https://surfacesyntacticud.github.io/guidelines/u/relations/comp_obj){target="_blank"}
    - [comp:obl](https://surfacesyntacticud.github.io/guidelines/u/relations/comp_obl){target="_blank"}
    - [comp:pred](https://surfacesyntacticud.github.io/guidelines/u/relations/comp_pred){target="_blank"}
- [mod](https://surfacesyntacticud.github.io/guidelines/u/relations/mod){target="_blank"}
