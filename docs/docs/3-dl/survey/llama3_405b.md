...
- Adversarial 对抗攻击？
    ...
    - `Dynabench SQuAD` (Kiela et al., 2021) dynamic benchmark collection，有一个网站 [Dynabench](https://dynabench.org/about){target="_blank"}，允许用户随时上传新的数据。
...
- [The Llama 3 Herd of Models](https://arxiv.org/abs/2407.21783){target="_blank"}
- [Llama 3.1论文精读 · 1. 导言【论文精读·54】](https://www.bilibili.com/video/BV1WM4m1y7Uh/?spm_id_from=333.337.search-card.all.click){target="_blank"}
- [Llama 3.1论文精读 · 2. 预训练数据【论文精读·54】](https://www.bilibili.com/video/BV1u142187S5/?spm_id_from=333.1365.list.card_archive.click&vd_source=add8ed6a0a0c3142a3e6ce9e4b286af6){target="_blank"}
